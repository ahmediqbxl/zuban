...
export const LEXEMES: LexemeRow[] = [
  ...
  // --- Vocabulary for the spoken phrases above ----------------------------
  ['অপেক্ষা', 'opekkha', 'waiting', 'noun', 470],
  ['আলাইকুম', 'alaikum', '(part of the greeting)', 'interj', 900],
  ['আসব', 'ashbo', 'I will come', 'verb', 330],
  ['আসসালাম', 'assalam', '(part of the greeting reply)', 'interj', 905],
  ['আসসালামু', 'assalamu', '(part of the greeting)', 'interj', 902],
  ['আস্তে', 'aste', 'slowly, gently', 'adv', 415],
  ['ইংরেজি', 'ingreji', 'English', 'noun', 375],
  ['এসেছি', 'eshechhi', 'I have come', 'verb', 425],
  ['এসেছেন', 'eshechhen', 'you have come (polite)', 'verb', 490],
  ['ওয়ালাইকুম', 'oyalaikum', '(part of the greeting reply)', 'interj', 908],
  ['কম', 'kom', 'less, fewer', 'adj', 176],
  ['করছি', 'korchhi', 'I am doing', 'verb', 260],
  ['করুন', 'korun', 'please do (polite)', 'verb', 290],
  ['কানাডা', 'canada', 'Canada', 'noun', 1200],
  ['কোথা', 'kotha', 'where (in phrases)', 'adv', 320],
  ['কোনো', 'kono', 'any, some', 'pron', 136],
  ['খিদে', 'khide', 'hunger', 'noun', 480],
  ['গেছি', 'gechhi', 'I have gone', 'verb', 385],
  ['চেষ্টা', 'chesta', 'effort, trying', 'noun', 345],
  ['জানেন', 'janen', 'you know (polite)', 'verb', 280],
  ['ঝাল', 'jhal', 'chilli heat, spicy', 'adj', 520],
  ['টয়লেট', 'toilet', 'toilet', 'noun', 560],
  ['তেষ্টা', 'teshta', 'thirst', 'noun', 640],
  ['থাকবেন', 'thakben', 'you will stay (polite)', 'verb', 430],
  ['দাম', 'dam', 'price', 'noun', 310],
  ['দেখা', 'dekha', 'meeting, seeing', 'noun', 214],
  ['নমস্কার', 'nomoshkar', 'hello (Hindu greeting)', 'interj', 540],
  ['নিরামিষ', 'niramish', 'vegetarian', 'adj', 720],
  ['নেব', 'nebo', 'I will take', 'verb', 400],
  ['পেয়েছে', 'peyechhe', 'has got, has received', 'verb', 270],
  ['বলুন', 'bolun', 'please say (polite)', 'verb', 300],
  ['বাংলাদেশ', 'bangladesh', 'Bangladesh', 'noun', 240],
  ['বুঝি', 'bujhi', 'I understand', 'verb', 350],
  ['মজা', 'moja', 'fun, tasty', 'adj', 365],
  ['যথেষ্ট', 'jothesto', 'enough', 'adj', 460],
  ['রাত্রি', 'ratri', 'night (formal)', 'noun', 610],
  ['লাগল', 'laglo', 'it felt, it seemed', 'verb', 335],
  ['শুভ', 'shubho', 'good, auspicious', 'adj', 405],
  ['সমস্যা', 'shomossha', 'problem', 'noun', 218],
  ['হয়েছে', 'hoyechhe', 'has happened, has become', 'verb', 150],
  ['হারিয়ে', 'hariye', 'having lost', 'verb', 580]
];
...
export const SENTENCES: SentenceRow[] = [
  ...
  // ═══ Spoken phrases ══════════════════════════════════════════════════════
  // Chosen for a learner whose goal is talking to people rather than
  // reading. Greetings, asking for things, and the small repair phrases
  // that keep a conversation alive when you only half understand.

  ['আসসালামু আলাইকুম।', 'assalamu alaikum.', 'Hello. (Muslim greeting, Bangladesh)', 1],
  ['ওয়ালাইকুম আসসালাম।', 'oyalaikum assalam.', 'And peace be upon you. (the reply)', 1],
  ['নমস্কার।', 'nomoshkar.', 'Hello. (Hindu greeting)', 1],
  ['আমার নাম কী?', 'amar nam ki?', 'What is my name?', 1],
  ['আপনার নাম কী?', 'apnar nam ki?', 'What is your name? (polite)', 1],
  ['আমি বুঝি না।', 'ami bujhi na.', 'I do not understand.', 1],
  ['আবার বলুন।', 'abar bolun.', 'Say that again. (polite)', 1],
  ['আস্তে বলুন।', 'aste bolun.', 'Please speak slowly.', 1],
  ['আমি একটু বাংলা জানি।', 'ami ektu bangla jani.', 'I know a little Bangla.', 2],
  ['ইংরেজি জানেন?', 'ingreji janen?', 'Do you speak English?', 2],
  ['এটা কত?', 'eta koto?', 'How much is this?', 2],
  ['খুব দাম।', 'khub dam.', 'That is expensive.', 2],
  ['একটু কম হবে?', 'ektu kom hobe?', 'Could it be a bit less?', 3],
  ['আমি এটা নেব।', 'ami eta nebo.', 'I will take this.', 2],
  ['টয়লেট কোথায়?', 'toilet kothay?', 'Where is the toilet?', 2],
  ['একটু সাহায্য করবেন?', 'ektu shahajjo korben?', 'Could you help me a moment?', 3],
  ['আমি হারিয়ে গেছি।', 'ami hariye gechhi.', 'I am lost.', 3],
  ['আমার খিদে পেয়েছে।', 'amar khide peyechhe.', 'I am hungry.', 3],
  ['আমার তেষ্টা পেয়েছে।', 'amar teshta peyechhe.', 'I am thirsty.', 3],
  ['এটা খুব মজা।', 'eta khub moja.', 'This is delicious.', 2],
  ['আর একটু দিন।', 'ar ektu din.', 'A little more, please.', 2],
  ['যথেষ্ট হয়েছে।', 'jothesto hoyechhe.', 'That is enough.', 3],
  ['আমি নিরামিষ খাই।', 'ami niramish khai.', 'I eat vegetarian food.', 3],
  ['ঝাল কম দিন।', 'jhal kom din.', 'Less chilli, please.', 3],
  ['দেখা হবে।', 'dekha hobe.', 'See you.', 1],
  ['ভালো থাকবেন।', 'bhalo thakben.', 'Take care. (polite)', 1],
  ['শুভ রাত্রি।', 'shubho ratri.', 'Good night.', 1],
  ['কিছু মনে করবেন না।', 'kichhu mone korben na.', 'Please do not mind. / No offence.', 3],
  ['কোনো সমস্যা নেই।', 'kono shomossha nei.', 'No problem.', 2],
  ['আমি চেষ্টা করছি।', 'ami chesta korchhi.', 'I am trying.', 3],
  ['আপনি কোথা থেকে এসেছেন?', 'apni kotha theke eshechhen?', 'Where are you from?', 4],
  ['আমি কানাডা থেকে এসেছি।', 'ami canada theke eshechhi.', 'I am from Canada.', 3],
  ['আমার পরিবার বাংলাদেশ থেকে।', 'amar poribar bangladesh theke.', 'My family is from Bangladesh.', 3],
  ['আমি বাংলা শিখতে চাই।', 'ami bangla shikhte chai.', 'I want to learn Bangla.', 3],
  ['আপনার সাথে কথা বলে ভালো লাগল।', 'apnar shathe kotha bole bhalo laglo.', 'It was nice talking with you.', 4],
  ['একটু অপেক্ষা করুন।', 'ektu opekkha korun.', 'Please wait a moment.', 3],
  ['আমি পরে আসব।', 'ami pore ashbo.', 'I will come later.', 2],
  ['ঠিক আছে, ধন্যবাদ।', 'thik achhe, dhonnobad.', 'All right, thank you.', 1]
];
